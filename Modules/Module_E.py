...
# --- User-controllable numerical parameters ---
...
# --- Inputs: damaged buildings (prefer memory) ---
...
# --- Inputs: OSM edges (prefer memory) ---
...
# ======== E2) Local UTM, reproject sources =========
...
# ============== E4) Dissolve buffers → islands; simplify; save QA ==============
...
# Keep geometry-only in the split outputs (adjust keep_cols if needed)
keep_cols = []  # e.g., ["highway", "osmid"]
if keep_cols:
...
# Buildings (must have "Damaged") — original selection logic kept
...
# Buffers (prefer dissolved; fallback to per-building)
...
# Reproject to local UTM (seed = buffers or buildings)
...
# Frame (manual bbox if provided, else auto)
